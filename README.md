...
- [Observed AI governance-refusal research](docs/research/observed-ai-build-assistant-governance-refusal.md)
- [Governance refusal fixture catalog](docs/research/governance-refusal-fixture-catalog.md)
- [Observed refusal evidence manifest](docs/evidence/observed-ai-governance-refusal-manifest.json)
...
- [Phase 84 synthetic policy key lifecycle research](docs/research/phase-84-synthetic-policy-key-lifecycle.md)
